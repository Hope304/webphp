...
<head>
  ...
  <meta name="description"
    content="Stylish - Shoes Online Store HTML Template" />
...
<body>
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none">
    <symbol xmlns="http://www.w3.org/2000/svg" id="shopping-carriage"
    ...
    <symbol xmlns="http://www.w3.org/2000/svg" id="quick-view"
      viewBox="0 0 24 24">
    ...
    <symbol xmlns="http://www.w3.org/2000/svg" id="dropdown"
      viewBox="0 0 24 24">
  ...
  <header id="header" class="header-sticky text-black">
    <nav id="header-nav" class="navbar navbar-expand-lg">
      <div class="container-lg">
        <a class="navbar-brand" href="index.php?controller=pages&action=home">
        ...
        <div tabindex="-1" id="bdNavbar">
          <div>
            <ul id="navbar"
              ...
              <li class="nav-item">
                <a class="nav-link me-5"
                  href="index.php?controller=pages&action=listProduct">Sale</a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <ul
            ...
            <li class="p-3">
              <a href="login" data-bs-toggle="modal"
                data-bs-target="#modallogin" class="border-0">
                <svg class="user" width="24" height="24">
                  <use xlink:href="#user"></use>
                </svg>
              </a>
            </li>
            <li class="p-3 shopping-card">
              <a href="index.php?controller=pages&action=cart" class="border-0">
  ...
  <footer id="footer" class="py-5 border-top">
    <div class="container-md">
      <div class="row">
        <div class="col-lg-3 pb-3">
          <div class="footer-menu">
            ...
            <ul class="menu-list list-unstyled">
              ...
              <li class="pb-2">
                <a href="index.php?controller=pages&action=home">Giới thiệu</a>
              </li>
              <li class="pb-2">
                <a href="#">Sản phẩm</a>
              </li>
        ...
        <div class="col-lg-3 pb-3">
          <div class="footer-menu">
            <h5 class="widget-title pb-2">Chính sách</h5>
            <ul class="menu-list list-unstyled">
              <li class="pb-2">
        ...
        <div class="col-lg-6 pb-3 d-flex justify-content-end">
          <div class="footer-menu ">
            <h2 class="widget-title pb-3">Stylish</h2>
            <div class="footer-contact-text">
              <span>Địa chỉ: Số7 Phú Lương, La Khê, Hà Đông, Hà Nội
              </span>
              <span>Số điện thoại: 037 5298 044 </span>
              <span class="text-hover fw-bold light-border"><a
                  href="mailto:contact@yourwebsite.com">stylish@gmail.com</a></span>
            </div>
          </div>
        </div>
      </div>
